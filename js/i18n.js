...
(function (global) {
  ...
  var STR = {
    ko: {
      ...
      'trust.h': '개인정보와 신뢰',
      'trust.p': '이 앱은 Google AdSense 광고를 게재하며, 광고 제공을 위해 Google 등 제3자가 쿠키를 사용할 수 있습니다. 그 외에 저희가 직접 수집하는 개인정보는 없고, 굴림 기록과 설정은 이 기기에만 남으며 언제든 직접 삭제할 수 있습니다.',
    ...
    en: {
      ...
      'trust.p': 'This app shows Google AdSense ads, and third parties such as Google may use cookies to serve them. Apart from that, we collect no personal information ourselves; your roll history and settings stay on this device and you can delete them anytime.',
