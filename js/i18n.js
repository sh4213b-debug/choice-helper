...
(function (global) {
  ...
  var STR = {
    ko: {
      ...
      'trust.h': '개인정보와 신뢰',
      'trust.p': '이 앱은 Google AdSense 광고를 게재하고, 사용성 개선을 위해 Microsoft Clarity로 방문 사용 행동을 분석하며, 이를 위해 제3자가 쿠키를 사용할 수 있습니다. 그 외에 이름·이메일 같은 개인정보는 요구하지 않고, 굴림 기록과 설정은 이 기기에만 남으며 언제든 직접 삭제할 수 있습니다.',
    ...
    en: {
      ...
      'trust.p': 'This app shows Google AdSense ads and uses Microsoft Clarity to analyze how the site is used to improve it; third parties may use cookies for these. Apart from that, we don’t ask for personal details like your name or email; your roll history and settings stay on this device and you can delete them anytime.',
