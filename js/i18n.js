...
(function (global) {
  ...
  var STR = {
    ko: {
      ...
      'home.eyebrow': '운명을 굴리다',
      'orb.hint': '수정구슬을 스크롤하거나 위아래로 쓸어 선택지를 바꾸세요',
      'orb.next': '이 선택으로 시작',
      'orb.aria': '선택지 개수',
      'about.h': '선택 도우미란?',
      ...
      'trust.h': '개인정보와 신뢰',
      'trust.p': '이 앱은 Google AdSense 광고를 게재하고, 사용성 개선을 위해 Google Analytics·Microsoft Clarity로 방문 사용 통계를 분석하며, 이를 위해 제3자가 쿠키를 사용할 수 있습니다. 그 외에 이름·이메일 같은 개인정보는 요구하지 않고, 굴림 기록과 설정은 이 기기에만 남으며 언제든 직접 삭제할 수 있습니다.',
    ...
    en: {
      ...
      'home.eyebrow': 'Roll your fate',
      'orb.hint': 'Scroll the orb, or swipe up/down, to change your options',
      'orb.next': 'Begin with this',
      'orb.aria': 'Number of options',
      ...
      'trust.p': 'This app shows Google AdSense ads and uses Google Analytics and Microsoft Clarity to analyze how the site is used to improve it; third parties may use cookies for these. Apart from that, we don’t ask for personal details like your name or email; your roll history and settings stay on this device and you can delete them anytime.',
